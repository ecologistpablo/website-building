...
date: 21-06-2026
categories: [movement, spatial, acoustic_telemetry]
description: "Categorising residency and non-residency (movement) in acoustic telemetry data using basic dplyr functions"
---
...
# we can also look at detections over time
  ...
  ggplotly(
    ggplot(dat_time, aes(x = date, y = transmitter_id, color = installation_name, size = num_det)) +
