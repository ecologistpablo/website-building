...
On dense quests (**`map`**, **`map2`**, **`pmap`**, **`safely`**, **`map_dfr`**), you will practice the same function on **two or three ecological tables** so the list structure — not the column names — is what you remember.
